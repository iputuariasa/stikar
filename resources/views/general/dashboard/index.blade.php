        ...
        @foreach ($newStudents as $newStudent)
            <section>
                <div class="container">
                    ...
                    @endif
                    @if (session()->has('confimBio'))
                        <div class="alert alert-warning alert-dismissible fade show" role="alert">
                            <strong>{{ session('confimBio') }}</strong>
                            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                        </div>
                    @endif
                    <div class="row">
                    ...
                    @if ($newStudent->jk == null)
                        <div class="alert alert-warning" role="alert">
                            <h5>Selamat Datang, {{ $newStudent->nama }} !</h5><small>Silakan Lengkapi Data Anda </small> 
                            <a href="/biodata">Biodata</a>
                        </div>
                    @else
                    <div class="alert alert-warning alert-dismissible fade show" role="alert">
                        <strong>Selamat Datang, {{ $newStudent->nama }}!</strong>
                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                    </div>
                    @endif
                </div>
